...
| [[algokit bug] App Factory deploy method fails to auto-increase requested fee amount via simulate if the min_fee value from suggested params was changed and cached](https://github.com/algorandfoundation/algokit-cli/issues/650) | 0 | 0 |
| [chore(deps): bump the all group across 1 directory with 7 updates](https://github.com/algorandfoundation/algokit-cli/pull/649) | 0 | 0 |
